...
<nav class="navbar navbar-default" >
  ...
  <form class="form-horizontal" role = "form" method = "post" action="deudoresMorososTelefono.php">
      ...
      <div class="row">
          ...
          <div class="col-xs-3">
             <input class="form-control" type="text" id="Telefono" name="Telefono" placeholder="Telefono Cliente" >
          </div>         
      </div>    
