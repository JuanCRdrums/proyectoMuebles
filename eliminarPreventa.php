<?php
  ...
  $SQL = "DELETE FROM preventa WHERE Numero LIKE $Numero ";
  $Registro = mysqli_query($idCone,$SQL);
  if(mysqli_query($idCone,$SQL))
  {
    $mensaje = "Preventa eliminada con éxito";
  }
  else
  {
    $mensaje = "Error eliminando la preventa";
  }
