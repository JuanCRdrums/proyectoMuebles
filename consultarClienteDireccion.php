  ...
  $SQL = "SELECT * FROM clientes WHERE (Empresa LIKE '$Empresa')";
    if(isset($_POST["submit"]))
    {
     $Direccion = $_POST["Direccion"];
      $SQL = "SELECT * FROM clientes WHERE (Direccion LIKE '%$Direccion%') AND (Empresa LIKE '$Empresa')";
    }
?>
...
<html lang="en">
<head>
  <title>Consultar Cliente Dirección</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default" >
  ...
  <h2 style="color:grey">Clientes</h2>

      <form class="form-horizontal" role = "form" method = "post" action="consultarClienteDireccion.php">
      <div class="row">
          <div class="col-xs-3"> 
