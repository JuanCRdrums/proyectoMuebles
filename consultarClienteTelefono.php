  ...
  $SQL = "SELECT * FROM clientes WHERE (empresa LIKE '$Empresa')";
    if(isset($_POST["submit"]))
    {
     $Telefono = $_POST["Telefono"];
      $SQL = "SELECT * FROM clientes WHERE (Telefono LIKE '%$Telefono%') AND (empresa LIKE '$Empresa')";
    }
?>
...
<html lang="en">
<head>
  <title>Consultar Cliente Telefono</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default" >
  ...
  <h2 style="color:grey">Clientes</h2>
      ...
      <form class="form-horizontal" role = "form" method = "post" action="consultarClienteTelefono.php">
