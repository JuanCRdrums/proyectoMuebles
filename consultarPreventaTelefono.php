...
<html lang="en">
<head>
  <title>Consultar Preventa Telefono</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default" >
  ...
  <h2 style="color:grey">Preventas</h2>
      ...
      <form class="form-horizontal" role = "form" method = "post" action="consultarPreventaTelefono.php">

        <div class="row">
            <div class="col-xs-2">
              <label for = "Telefono" class = "control-label" style="color:white">Telefono del Cliente:</label> 
            </div>
            <div class="col-xs-3">
