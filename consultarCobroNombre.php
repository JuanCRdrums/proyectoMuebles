...
<html lang="en">
<head>
  <title>Consultar Cobro Nombre</title>
  <meta charset="utf-8">
...
<nav class="navbar navbar-default" >
  ...
  <form class="form-horizontal" role = "form" method = "post" action="consultarCobroNombre.php">
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
              <input class="form-control" type="text" id="Nombre" name="Nombre" placeholder="Nombre de cliente"> 
            </div>            
        </div>
        <br>
        <div class = "row">
